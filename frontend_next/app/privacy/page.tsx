...
export const metadata: Metadata = {
  title: 'Politique de Confidentialité – Cosy Casa',
  description: 'Politique de confidentialité de Cosy Casa Conciergerie, conforme au RGPD.',
};
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-gray max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="orso-body">Nous collectons les données suivantes lorsque vous utilisez notre site :</p>
            ...
            <section>
              ...
              <p className="orso-body">Vos données personnelles sont utilisées pour :</p>
              <ul className="list-disc pl-6 orso-body space-y-2 mt-4">
            ...
            <section>
              ...
              <p className="orso-body">Le traitement de vos données est fondé sur :</p>
              <ul className="list-disc pl-6 orso-body space-y-2 mt-4">
            ...
            <section>
              ...
              <p className="orso-body">Vos données peuvent être transmises à :</p>
              <ul className="list-disc pl-6 orso-body space-y-2 mt-4">
              ...
              <p className="orso-body mt-4">Nous ne vendons jamais vos données personnelles à des tiers.</p>
            </section>

            <section>
              <h2 className="orso-h3 mb-4">7. Durée de conservation</h2>
              <p className="orso-body">Vos données sont conservées pendant :</p>
              <ul className="list-disc pl-6 orso-body space-y-2 mt-4">
            ...
            <section>
              ...
              <p className="orso-body">Conformément au RGPD, vous disposez des droits suivants :</p>
              <ul className="list-disc pl-6 orso-body space-y-2 mt-4">
            ...
            <section>
              ...
              <p className="orso-body">
                ...
                <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="text-[#2e2e2e] underline">www.cnil.fr</a>
              </p>
            </section>
