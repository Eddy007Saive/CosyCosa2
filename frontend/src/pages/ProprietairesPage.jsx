...
const SERVICES = [
  ...
  },
  {
    ...
    icon: Shield,
    items: [
      "Carnet d'adresse : maintenances/réparations",
      "Retard",
      "Oublis voyageurs",
      "Dommages"
    ]
    ...
    <div data-testid="proprietaires-page">
      ...
      <section className="relative min-h-[50vh] flex items-center justify-center bg-[#2e2e2e] pt-20">
        <div className="relative z-10 text-center text-white px-6 max-w-3xl mx-auto">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl leading-tight mb-6" data-testid="proprietaires-title">
            {t('proprietaires.hero.title')}
          </h1>
          <p className="text-lg font-light text-white/80 leading-relaxed">
            {t('proprietaires.hero.subtitle')}
          </p>
        </div>
      </section>
      ...
      {/* Services Grid */}
      <section className="pb-20 bg-white" data-testid="services-grid">
        <div className="orso-container">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {SERVICES.map(({ key, icon: Icon, items }, index) => (
              ...
              >
                ...
                <h3 className="font-serif text-xl text-[#2e2e2e] mb-5">
                  {titles[key]}
                </h3>
      ...
      {/* Tarif Section */}
      <section className="orso-section bg-[#2e2e2e] text-white" data-testid="tarif-section">
        <div className="orso-container">
      ...
      {/* Espace Propriétaire */}
      <section className="orso-section bg-white" data-testid="espace-section">
        <div className="orso-container">
      ...
      <section className="bg-[#f5f5f3] py-20">
        <div className="orso-container text-center">
          ...
          <Link to="/contact-conciergerie-cosy-casa">
            <Button className="orso-btn-primary" data-testid="proprietaires-cta-btn">
              {t('nav.contact')}
