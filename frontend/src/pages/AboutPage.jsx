...
const AboutPage = () => {
  ...
  useSEO({
    title: 'À propos – Conciergerie Cosy Casa en Corse',
    description: "Conciergerie Cosy Casa Corse – Découvrez l'histoire, les valeurs et la passion derrière notre conciergerie locative en Corse-du-Sud.",
    path: '/a-propos-conciergerie-cosy-casa-en-corse',
  });
    ...
    <div data-testid="about-page">
      ...
      >
        ...
        <div className="relative z-10 text-center text-white">
          <h1
            className="font-serif text-4xl sm:text-5xl lg:text-6xl tracking-tight mb-4"
      ...
      {/* Julie - Fondatrice */}
      <section className="orso-section" data-testid="about-julie-section">
        <div className="orso-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div>
              ...
              <h2 className="orso-h2 mb-8" data-testid="about-julie-name">Julie</h2>
      ...
      {/* Nos valeurs */}
      <section className="orso-section bg-[#f5f5f3]" data-testid="about-values-section">
        <div className="orso-container">
          <div className="text-center mb-16">
            <p className="orso-caption mb-4">Ce qui nous guide</p>
            <h2 className="orso-h2" data-testid="about-values-title">Nos valeurs</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            {VALUES.map((v) => (
              <div
                key={v.key}
                className="bg-white p-8 lg:p-10 border border-gray-100 hover:border-gray-300 transition-colors"
                data-testid={`about-value-${v.key}`}
              >
          ...
          <div className="text-center mt-12">
            <Link to="/contact-conciergerie-cosy-casa">
              <Button className="orso-btn-primary" data-testid="about-values-cta">
                En savoir plus
      ...
      <section className="orso-section" data-testid="about-eco-section">
        <div className="orso-container max-w-4xl">
          <div className="text-center mb-16">
            ...
            <h2 className="orso-h2" data-testid="about-eco-title">Nos engagements éco responsables</h2>
          </div>

          <ul className="space-y-5" data-testid="about-eco-list">
