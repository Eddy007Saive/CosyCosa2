...
const ConciergeriePage = () => {
  ...
  return (
    <div data-testid="conciergerie-page">
        ...
        <div className="orso-container">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-lg font-light leading-relaxed text-gray-700 mb-6">
              {t('conciergerie.intro')}
            </p>
            <p className="text-lg font-light leading-relaxed text-gray-600">
              {t('conciergerie.intro2')}
            </p>
          </div>
        </div>
      </section>
      ...
      {/* Offers */}
      <section className="orso-section bg-[#f5f5f3]" data-testid="offers-section">
        <div className="orso-container">
      ...
      {/* Advantages */}
      <section className="orso-section bg-white" data-testid="advantages-section">
        <div className="orso-container">
